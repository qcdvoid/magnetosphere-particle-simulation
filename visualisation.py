...
axs[0].plot(t,x)
axs[0].set_title('x(t)')
axs[0].set_xlabel('t (en s)')
axs[0].set_ylabel('x (en m)')

axs[1].plot(t,y)
axs[1].set_title('y(t)')
axs[1].set_xlabel('t (en s)')
axs[1].set_ylabel('y (en m)')

##INVARIANTS ET PÉRIODES
...
axs2[0].set_xlabel('t (en s)')
axs2[0].set_ylabel(r'$\mu$ (en C.m)')
...
axs2[1].set_xlabel('Demi-périodes')
axs2[1].set_ylabel('J (en m^2/s)')
axs2[1].legend()
...
axs3[0].set_title('Tx(t), sur une période')
axs3[0].set_xlabel('t (en s)')
axs3[0].set_ylabel('Tx (en s)')
axs3[0].legend()

axs3[1].plot(Ty[:-1,0],Ty[:-1,1], label='<Ty> = '+str('{:.4e}'.format(Ty[-1,0])))
axs3[1].set_title('Ty(t), sur une période')
axs3[1].set_xlabel('t (en s)')
axs3[1].set_ylabel('Ty (en s)')
axs3[1].legend()
...
axs4[0].plot(t,z)
axs4[0].scatter(tz,exz, marker='*', color='red', label="extremas de z(t)")
axs4[0].set_title('z(t)')
axs4[0].set_xlabel('t (en s)')
axs4[0].set_ylabel('z (en m)')
axs4[0].legend()

axs4[1].scatter(Tz[:-1,0],Tz[:-1,1], label='<Tz> = '+str('{:.4e}'.format(Tz[-1,0])))
axs4[1].set_title('Tz(t), sur une période')
axs4[1].set_xlabel('t (en s)')
axs4[1].set_ylabel('Tz (en s)')
axs4[1].legend()
